select e.event_id, e.event_name, e.address, e.sport, e.users_id, e.img,
...
group by e.event_id, event_name, address, e.sport, e.users_id, dateofevent, starttime, endtime, img
UNION
select e.event_id, e.event_name, e.address, e.sport, e.users_id, e.img,
TO_CHAR(e.dateofevent :: DATE, 'Mon dd, yyyy') as dateofevent, 
TO_CHAR(e.starttime :: TIME, 'HH:MI:AM') as starttime,
...
group by e.event_id, event_name, address, sport, e.users_id, dateofevent, starttime, endtime, img
